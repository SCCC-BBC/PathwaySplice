...
postprocessgo <- function(n.go, adjusted, unadjuasted, venn.dir, 
  ...
  adjusted <- Example.Go.adjusted.by.exon$GO.selected[1:n, 
    1]
  ...
  In.un.not.ad <- Example.Go.unadjusted$GO.selected[index2, 
    ]$Ave_value_all_gene
