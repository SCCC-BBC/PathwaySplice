...
testPathwaySplice <- function(gene_based_table,which_gene_model) {
  ...
  #Analysis
  Example.Go.adjusted.by.exon<-Run_pathwaysplice(gene_based_table,ad="exon_SJ",sub_feature="E",0.05,genomeID="hg19",geneID="ensGene",gene_model=which_gene_model,method="Wallenius")
  Example.Go.unadjusted<-Run_pathwaysplice(gene_based_table,ad="exon_SJ",sub_feature="E",0.05,genomeID="hg19",geneID="ensGene",gene_model=which_gene_model,method="Hypergeometric")
