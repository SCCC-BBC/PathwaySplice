...
```{r eval=TRUE, message=FALSE, warning=FALSE,results='markup',fig.show='hide'}
...
result.kegg <- runPathwaySplice(gene.based.table,genome='hg19',
                                id='ensGene',
...
To illustrate the advantages of using PathwaySplice, we next illustrate analysis using the entire xx genes in the mds dataset. 
