...
#read from url
#gene.2.cat.hallmark.hg.from.url<-Gmt2GeneCat("http://software.broadinstitute.org/gsea/msigdb/download_file.jsp?filePath=/resources/msigdb/5.2/h.all.v5.2.symbols.gmt","url","/media/H_driver/Annotation/hg38/genes_table_02092016.csv")
