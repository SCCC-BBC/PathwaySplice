...
# Use PathwaySplice
PathwaySplice uses the output from DEXSeq or JunctionSeq as input basis. Assume users have gotten the differnetial exon usage or differential splicing junctions usage results from DEXSeq or JunctionSeq. User needs to convert these resutls into gene based table, then use this gene based table to perform analysis using the following commands:
```{r eval=FALSE, message=FALSE, warning=FALSE, results='hide'}
