...
```{r, echo = FALSE}
<<<<<<< HEAD
knitr::opts_chunk$set(fig.width=8,fig.height=7,collapse = FALSE, comment = "#>")
=======
...
For example, the results for the [MSigDB Hallmark gene sets](http://software.broadinstitute.org/gsea/msigdb/collections.jsp) are
```{r eval=TRUE,warning=FALSE,message=FALSE,results = 'markup'}
