...
```{r eval=TRUE, warning=FALSE,message=FALSE,results ='markup', fig.align='right', fig.height=6, fig.width=14}
...
The venn diagram below shows that among the top 20 most significant GO categories identified in adjusted and unadjusted analysis, there were 8 common GO categories. 
