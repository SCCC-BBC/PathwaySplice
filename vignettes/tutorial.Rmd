...
To handle Reactome pathway annotationsReactome, one can download the [.gmt format](https://reactome.org/download-data) of these annotations to somewhere, then perform analysis as the following:
```{r eval=FALSE, message=FALSE, warning=FALSE,results='hide',fig.show='hide'}
...
To handle KEGG pathway annotations, one can perform analysis as the following steps: 
```{r eval=FALSE, message=FALSE, warning=FALSE,results='hide',fig.show='hide'}
