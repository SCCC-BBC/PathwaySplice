...
second, we permutate maping count 

By this way, we attemp to identify the same enriched gene sets and pathways of GO and KEGG. If there are high consistencies between the resutls from ramdom data sets and that of real data sets, this indicate that the number of subfeatures of genes has cause bias on gene set enrichment analysis.
