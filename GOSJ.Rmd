...
We have 13000 gene, each have there speficif numern features, in this smualrion, we fix the numer of suaberfeature for each gene as the real data, and do the following simlmaulation:

first , we permutate sample label

second, we permuatte maping count 

By this way, we attemp to identify the same set of GO and KEGG. If there are hight consistencies between the resutls from ramdom fdtae ans dthat of real data set, this indicate the number of subfeatures of genes have cause bias on gene set enrichment analysis.
