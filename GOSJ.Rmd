...
In each simulation,we generate 50 gene sets,and each gene set includes 30 gene.  

The following plot shows the distribution of correlation coefficient between the probability of being 1 and the median number of splicing junctions for two scenarios:
...
>>>>>>> 70041712827456c50c2a40d3e89cb076d1473e55
